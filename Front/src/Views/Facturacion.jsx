  ...
  return (
   <div>
     ...
     <div className="grid grid-cols-2 gap-4 h-[80%]">
       ...
       <div className="col-span-1 bg-white rounded-[20px] m-4 flex flex-col justify-start max-w-[900px] h-[500px] shadow-md p-6 overflow-auto">
         <h1 className="text-2xl font-bold mb-4">Ticket de Comandera</h1>
